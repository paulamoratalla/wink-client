        ...
        return (
            <div>
                <Container>
                    ...
                    <Row>
                        <Col xs={1}> <Fade left> <h1>1</h1>   </Fade></Col>
                        <Col xs={11}>    <Fade left> <h4>Create an account</h4>
                    ...
                    <Row>
                        <Col xs={1}> <Fade left> <h1>2</h1>   </Fade></Col>
                        <Col xs={11}>    <Fade left> <h4>Meet new people</h4>
                    ...
                    <Row>
                        <Col xs={1}> <Fade left> <h1>3</h1>   </Fade></Col>
                        <Col xs={11}>    <Fade left> <h4>Get a date</h4>
